...
export default function PriceCard({
  ...
  return (
   <Card className={header ? 'pakage__card active' : 'pakage__card'} sx={styles.pricingBox}>
{header && <Text sx={styles.header}>{header}</Text>}
   
   <Box ><Box className="pakage__header" sx={styles.pricingHeader}>
<Heading className="pakage__name" variant="title">
{name}
</Heading>
<Text as="p">{description}</Text>
   </Box>
   <List items={points} childStyle={styles.listItem} />
   <Text className="pakage__price" sx={styles.price}>
     {priceWithUnit}
     <span>Monthly</span>
   </Text>
